# Claude Stack Audit — 2026-04-20

**Health score: 961 / 1000**
...
| OBS001 | automation | observability | `claude/hooks/auto-format.sh` | log write to non-approved path: $DRIFT_LOG | Use one of: $CLAUDE_LOG_DIR, ~/Library/Logs/claude-crons/, or ~/.claude/logs/ instead of ad-hoc paths. |
...
---
_Generated by cstack-audit 0.1.0 at 2026-04-20T20:40+00:00 · tools: jq jq-1.8.1, shellcheck ShellCheck - shell script analysis tool_